  ...
  <div id="container">
    <div class="content">
      ...
      <form class="" action="std_update.php" method="get">
        ...
        <input type="text"  id="batch" name="year" placeholder="Enter Batch" required value="<?php echo $year ?>">
        ...
        <input id="sem" type="text" name="sem" placeholder="Enter semester" required value="<?php echo   $sem_id ?>">

        <label for="contact">Contact Number</label>
        <input id="contact" type="text" name="contact" placeholder="Enter contact number" required value="<?php echo  $contact ?>">

        <label for="email">Email</label>
        <input id="email" type="email" name="email" placeholder="Your email" required value="<?php echo $email ?>">

        <label for="uname">User Name</label>
        <input id="uname" type="text" name="user_name" placeholder="@user name" required value="<?php echo  $uname ?>">
