          ...
          <!-- php code to display sql table  -->
            ...
            if($result){
              while($row=$result->fetch_assoc()){
                ...
                <?php
                  //SQL query to display student attendance record table.
                  $sql2="SELECT * FROM `attendance_record` a natural join`student` s WHERE a.date='$date' AND a.subject='$subject' order by rollno" ;
