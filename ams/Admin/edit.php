  ...
  <div id="container">
    <div class="content">
      ...
      <form action="update.php?ID=<?php echo $userID;?>" method="post">
        ...
        <input id="uname" type="text" name="user_name" placeholder="@user" required value="<?php echo $uname ?>">

        <label for="contact">Contact Number</label>
        <input id="contact" type="text" name="contact_number" placeholder="Enter contact number" required value="<?php echo  $contact ?>">
